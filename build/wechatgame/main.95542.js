(function () {
    ...
    function boot () {
        ...
        {
            var bundledScript = settings.debug ? 'src/project.dev.96031.js' : 'src/project.js';
            if (jsList) {
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.b4b5f.js' : 'cocos2d-js-min.js';
